    ...
    function breezeEntities(common) {
        ...
        function fillMetadataStore() {
            ...
            function addTravelRequest() {
                addType({
                    name: 'TravelRequests',
                    defaultResourceName: 'getbytitle(\'Travel Requests\')/items',
                    dataProperties: {
                        Id: { type: breeze.DataType.Int32 },
                        Title: { nullable: false },
                        AccomodationCosts: {type: breeze.DataType.Currency},
                        TravelCosts: { type: breeze.DataType.Currency },
                        MiscCosts: { type: breeze.DataType.Currency },
                        MealCosts: { type: breeze.DataType.Currency },
                        ArrivalDate: {type: breeze.DataType.DateTime},
                        DepartureDate: { type: breeze.DataType.DateTime },
                        Destination: {},
