(function () {
    ...
    function spWorkflow($q, common, datacontext) {
        ...
        var travelRequestListId = undefined;
        ...
        function startWorkflowOnListItem(listItemId, wfStartParams) {
            ...
            // get the travel request list id
            promises.push(datacontext.getTravelRequestListId());
            ...
            $q.all(promises)
              .then(function (responses) {
                  ...
                  // get list id
                  travelRequestListId = responses[1].travelRequestListId;
              })
              .then(function () {
                  ...
                  getWorkflowDefinitionId()
                    .then(function (wfdResponse) {
                        ...
                        getWorkflowSubscription(travelRequestListId, wfDefinitionId)
            ...
            if (wfDefinitionId) {
                ...
                spClientContext.executeQueryAsync(function () {
                    ...
                    while (enumerator.moveNext()) {
                        if (enumerator.get_current().get_displayName() === 'TravelRequestApproval') {
                    ...
                    if (wfId) {
                        ...
                        deferred.reject({ errorMessage: 'unable to find workflow definition for workflow named \'ApprovalWorkflow - ItemAdded\'' });
                    }
                });
            }
            ...
            if (wfSubscriptionId) {
                ...
                spClientContext.executeQueryAsync(function () {
                    ...
                    if (wfSubId) {
                        ...
                        deferred.reject({ errorMessage: 'unable to find workflow subscription for workflow named \'Approve Travel Request Workflow\' on listID \'' + listId + '\'' });
                    }
                });
            }
